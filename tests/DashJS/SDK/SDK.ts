...
const mnemonic =
  "agree country attract master mimic ball load beauty join gentle turtle hover";
describe("DashJS - SDK", () => {
  ...
  it("should initiate platform and only set contract when schema provided", function() {
    ...
    expect(sdkWithSchema.platform.contractId).to.equal(
      "4bGwCHfGZYHkAi6ut4Ppm5qSUHSb7zcTFMmLKomrHLcg"
    );
  });
});
